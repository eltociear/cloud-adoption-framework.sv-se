...
Lär dig hur du [använder mallen för affärs resultat](./how-to-use-the-business-outcome-template.md).

> [!div class="nextstepaction"]
> [Använd mallen affärs resultat](./how-to-use-the-business-outcome-template.md)
