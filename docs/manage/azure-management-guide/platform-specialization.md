---
title: Specialiserade plattformar för molnhantering
description: Använd Cloud Adoption Framework för Azure för att förbättra plattformsspecifika åtgärder för molnhantering, till exempel genom att förbättra systemets utformning och automatiserade åtgärder.
