---
title: Revara Host på en lokal app på virtuella Azure-datorer med Azure Site Recovery
description: Använd ramverket för moln införande för Azure för att lära dig hur du kan vara värd för en lokal app med en migrering av lokala datorer till Azure.
