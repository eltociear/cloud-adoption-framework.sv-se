...
description: Använd Cloud Adoption Framework för Azure för att lära dig hur du konfigurerar övervakning, rapportering och aviseringar för din Azure-miljö.
author: timleyden
ms.author: tileyden
ms.date: 04/09/2019
ms.topic: guide
