...
![Exempel på en MVP för inkrementell styrnings](../../../_images/governance/governance-mvp-implementation-flow.png)
...
- [Loggnings-och rapporterings mönster](../../../decision-guides/log-and-report/index.md)
...
> [Förbättra disciplinen för identitets bas linjer](./identity-baseline-evolution.md)
