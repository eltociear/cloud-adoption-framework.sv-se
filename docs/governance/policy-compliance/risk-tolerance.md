...
- **Data intrång:** Antalet en risk som associeras med en transformering är data skyddet. Data läckor kan orsaka betydande skador på företaget, vilket leder till förlust av kunder, minskad verksamhet eller till och med juridiskt ansvar. Ändringar av hur data lagras, bearbetas eller används skapar risker. Moln omvandlingar skapar en hög grad av ändring för data hantering, så risken bör inte beaktas lätt. [Säkerhets bas linjen](../security-baseline/index.md), [data klassificering](./what-is-data-classification.md)och [stegvisa rationalisering](../../digital-estate/rationalize.md#incremental-rationalization) kan användas för att hantera den här risken.
...
> [Definiera företags princip](./define-policy.md)
