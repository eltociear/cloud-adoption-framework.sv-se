...
**Design alternativ:** Information om hur du upprättar en framtida gransknings grund finns i diskussionerna om att skapa en styrnings-MVP i de användbara [design guiderna](../journeys/index.md) som ingår i vägledningen för moln implementerings ramverk.
...
**Design alternativ:** I Azure kan du kontrol lera budgeten med [Azure Cost Management](/azure/cost-management/manage-budgets)
...
- I Azure kan planerade kontra faktiska utgifter hanteras via [Azure Cost Management](/azure/cost-management/quick-acm-cost-analysis)
...
- I Azure kan [Azure Advisor](/azure/advisor/advisor-cost-recommendations) tillhandahålla optimerings rekommendationer.
- Det finns flera alternativ för att gruppera resurser efter fakturerings enhet. I Azure väljs en [resurs konsekvens modell](../../decision-guides/resource-consistency/index.md) tillsammans med styrnings teamet och tillämpas på alla till gångar.
...
- I Azure kan [Azure Monitor insikter-funktioner](/azure/azure-monitor/insights/vminsights-performance) hjälpa till med analys av system användning.
